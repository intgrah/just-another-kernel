...
pub const Env = struct {
    ...
    pub const nil: Env = .{ .v = undefined, .parent = undefined, .frame = null, .lsub = null, .hash = 0, .len = 0, .trunc_k = std.math.maxInt(u32), .trunc_r = undefined, .prune_mask = 0, .prune_r = undefined };
...
pub fn envExtend(arena: *Arena, parent: E, v: V) E {
    ...
    e.* = .{ .v = v, .parent = parent, .frame = null, .lsub = parent.lsub, .hash = hash, .len = parent.len + 1, .trunc_k = std.math.maxInt(u32), .trunc_r = undefined, .prune_mask = 0, .prune_r = undefined };
    return e;
}
